          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              <SimpleGrid columns={2} spacing={10}>
                <Button bg='branding.700' color='white' borderRadius={10} p='5' justifyContent={'center'} mt={10} onClick={() => Router.push('/singleTicket/Payment')}>
                  R$ 10,00
                </Button>
                <Button bg='branding.700' color='white' borderRadius={10} p='5' justifyContent={'center'} mt={10} onClick={() => Router.push('/singleTicket/Payment')}>
                  R$ 20,00
                ...
                <Button bg='branding.700' color='white' borderRadius={10} p='5' justifyContent={'center'} mb={10} mt={10} onClick={() => Router.push('/singleTicket/Payment')}>
                  Outro Valor
                </Button>
              </SimpleGrid>
              </Flex>
