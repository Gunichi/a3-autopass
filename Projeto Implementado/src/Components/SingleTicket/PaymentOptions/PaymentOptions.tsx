          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Flex align='center' justify='center' direction='column' bg='branding.500'>
                <Flex bg='branding.700' p={5} color='white' borderRadius={10} width={'40%'} justifyContent={'center'} mb={10} mt={10} direction={'row'} onClick={() => Router.push('/singleTicket/debit/Card')} cursor={'pointer'}>
                  <Text fontSize={'2xl'} color={'white'} textAlign={'center'} fontWeight={'bold'} mr={5}>
                    Débito
                  </Text>
                  <AiOutlineCreditCard size={35} />
                </Flex>
                <Flex bg='branding.700' p={5} color='white' borderRadius={10} width={'40%'} justifyContent={'center'} mb={10} direction={'row'} onClick={() => Router.push('/singleTicket/money/validate')} cursor='pointer' >
                  <Text fontSize={'2xl'} color={'white'} textAlign={'center'} fontWeight={'bold'} mr={5}>
                    Dinheiro
                  </Text>
                  <BsCash size={35} />
